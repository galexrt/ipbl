PROJECTNAME ?= ipbl
DESCRIPTION ?= ipbl - Application which can be used to create per host, group, global ip list
MAINTAINER  ?= Alexander Trost <galexrt@googlemail.com>
HOMEPAGE    ?= https://github.com/galexrt/ipbl
...
package-%: build
	...
	cp .build/ipbl $(PACKAGE_DIR)/usr/bin
	cp systemd/ipbl.service $(PACKAGE_DIR)/lib/systemd/system
	cp systemd/sysconfig.ipbl $(PACKAGE_DIR)/etc/sysconfig/ipbl
